...
# Constants for Admin, Organizer, and Application Users
ACCOUNT_LOCKOUT_DURATION_HOURS = 24
MAX_LOGIN_ATTEMPTS_BEFORE_LOCKOUT = 3

INITIAL_LOGIN_STATUS = -1
ACTIVE_LOGIN_STATUS = 0
ACCOUNT_LOCKED_STATUS = 1
PASSWORD_EXPIRED_STATUS = 2
