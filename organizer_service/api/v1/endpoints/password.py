...
from organizer_service.schemas.password import (
    ForgotPassword,
    ResetPasswordWithToken,
    UserChangePassword,
    UserPasswordReset,
)
from organizer_service.services.password_reset_service import (
...
async def reset_password(
    ...
    """Reset password for authenticated user (admin function)"""
