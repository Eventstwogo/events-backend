...
- PUT /slug/{slug} - Update subcategory by slug
- DELETE /slug/{slug}/soft - Soft delete subcategory by slug
- PUT /slug/{slug}/restore - Restore subcategory by slug
- DELETE /slug/{slug}/hard - Hard delete subcategory by slug
"""
...
class TestUpdateSubcategoryBySlug:
    ...
    async def test_update_subcategory_by_slug_success(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/electric-cars", data=data
        )
        body = res.json()
    ...
    async def test_update_subcategory_by_slug_not_found(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/nonexistent", data=data
        )
        body = res.json()
    ...
    async def test_update_subcategory_slug_change(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/italian-cuisine", data=data
        )
        body = res.json()
    ...
    async def test_update_subcategory_duplicate_name(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/cats", data=data
        )
        body = res.json()
    ...
    async def test_update_subcategory_with_file_upload(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/painting", data=data, files=files
        )
        body = res.json()
    ...
    async def test_update_subcategory_invalid_filename(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/portraits",
            data=data,
            files=files,
        )
        body = res.json()
    ...
    async def test_update_subcategory_partial_update(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/classical", data=data
        )
        body = res.json()
...
class TestSoftDeleteSubcategoryBySlug:
    ...
    async def test_soft_delete_subcategory_by_slug_not_found(
        ...
        res = await test_client.delete(
            "/api/v1/subcategories/slug/nonexistent/soft"
        )
        body = res.json()
...
class TestRestoreSubcategoryBySlug:
    ...
    async def test_restore_subcategory_by_slug_success(
        ...
        res = await test_client.put("/api/v1/subcategories/slug/poetry/restore")
        body = res.json()
    ...
    async def test_restore_subcategory_by_slug_not_found(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/nonexistent/restore"
        )
        body = res.json()
    ...
    async def test_restore_already_active_subcategory_by_slug(
        ...
        res = await test_client.put(
            "/api/v1/subcategories/slug/ancient-history/restore"
        )
        body = res.json()
...
class TestHardDeleteSubcategoryBySlug:
    ...
    async def test_hard_delete_subcategory_by_slug_success(
        ...
        res = await test_client.delete(
            "/api/v1/subcategories/slug/forests/hard"
        )
        body = res.json()
    ...
    async def test_hard_delete_subcategory_by_slug_not_found(
        ...
        res = await test_client.delete(
            "/api/v1/subcategories/slug/nonexistent/hard"
        )
        body = res.json()
