...
class SubCategoryValidationData(BaseModel):
    ...
    meta_description: str = Field(
        "", description="Subcategory meta description"
    )
...
class SubCategoryValidationResult(BaseModel):
    ...
    cleaned_description: str = Field(
        ..., description="Cleaned subcategory description"
    )
    cleaned_meta_title: str = Field(
        ..., description="Cleaned subcategory meta title"
    )
    cleaned_meta_description: str = Field(
        ..., description="Cleaned subcategory meta description"
    )
